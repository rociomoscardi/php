    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseProductos" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="producto_listado.php">Listado de productos</a>
            <a class="collapse-item" href="tipoproducto_listado.php">Tipo de productos</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseVentas" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="venta_formulario.php">Nueva venta</a>
            <a class="collapse-item" href="venta_listado.php">Listado de ventas</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUsuario" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="usuario_formulario.php">Nuevo usuario</a>
            <a class="collapse-item" href="usuario_listado.php">Listado de usuarios</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
